...
export const CLOSE_COMMENTFORM: any = (data: any): any => action(actionTypes.CLOSE_COMMENTFORM, data)
export const SEND_COMMENTFORM: any = (data: any): any => action(actionTypes.SEND_COMMENTFORM, data)
