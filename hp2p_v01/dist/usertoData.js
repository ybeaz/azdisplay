...
var USERTO = {
  ...
  eng: {
    ...
    descriptors: {
      sid: 'Descriptors',
      h1: '<span class="Descriptors__h1_eng_0">Select specialist</span> <span class="Descriptors__h1_eng_1">to solve the question</span> <span class="Descriptors__h1_e_2">online</span>',
      h2: 'Fast, convenient<br />chat, audio or video', 
    },
    carousel: {
      sid: 'CarouselDesc',
      listArr: [
    ...
    searchForm: {
      sid: 'SearchForm',
      searchPlaceholder: 'Field and/or question...',
      searchButton: 'Find',
      alertShortSearchInput: 'Too short search request',
      typeRequest: {
        sid: 'FieldButtons_typeRequest',
        listArr: [
          { capture: 'All', active: true, general: true },
          { capture: 'Consultation', active: false, general: false },
          { capture: 'Education', active: false, general: false },
          { capture: 'Frelance', active: false, general: false },
        ],
        isGenaralShowAlways: false,
        isGeneralShowPhone: false,
      },
      typeMedia: {
        sid: 'Dropdown_typeMedia',
        listArr: [
          { capture: 'All types', iconFa: ['fas fa-video', 'fas fa-phone', 'fas fa-comments'], active: true, general: true },
          { capture: 'Video', iconFa: ['fas fa-video'], active: false, general: false },
          { capture: 'Audio', iconFa: ['fas fa-phone'], active: false, general: false },
          { capture: 'Messenger', iconFa: ['fas fa-comments'], active: false, general: false },
        ],
        delay: 500,
      },
    },
    catatogTags: {
      sid: 'CatalogTags',
      captureSection: 'Catalog',
      captureButtonShowAll: 'Show all',
      captureButtonCompact: 'Compact',
      listArr: [
        { capture: 'Вопросы бизнеса', iconClass: '', num: 639, iconFa: 'fas fa-user-tie' },
        { capture: 'Компьютеры и IT', iconClass: 'iconFire', num: 917, iconFa: 'fas fa-laptop' },
        { capture: 'Ремонт авто', iconClass: 'iconFire', num: 92, iconFa: 'fas fa-car-crash' },
