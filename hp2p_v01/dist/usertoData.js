    ...
    treeDefault: {
      ...
      catatogTags: {
        ...
        listArr: [
          ...
          { capture: 'Ремонт авто', iconClass: 'iconFire', num: 92, iconFa: 'fas fa-car' },
          { capture: 'Юридические вопросы', iconClass: '', num: 688, iconFa: 'fas fa-gavel' },
          { capture: 'Здоровье', iconClass: '', num: 3166, iconFa: 'fas fa-medkit' },
          ...
          { capture: 'Ремонт и строительство', iconClass: 'iconFire', num: 319, iconFa: '' },
          { capture: 'Красота', iconClass: '', num: 711, iconFa: '' },
          { capture: 'Саморазвитие', iconClass: 'iconFire', num: 452, iconFa: '' },
          { capture: 'Фото', iconClass: '', num: 447, iconFa: '' },
          { capture: 'Аудио', iconClass: 'iconFire', num: 417, iconFa: '' },
          { capture: 'Творчество и хобби', iconClass: '', num: 1344, iconFa: '' },
          { capture: 'Медицинские вопросы', iconClass: '', num: 927, iconFa: '' },
          { capture: 'Путешествия', iconClass: '', num: 401, iconFa: '' },
          { capture: 'Религия', iconClass: '', num: 838, iconFa: '' },
          { capture: 'Искусство', iconClass: '', num: 2162, iconFa: '' },
          { capture: 'Недвижимость', iconClass: '', num: 4304 },
          { capture: 'Покупка авто', iconClass: '', num: 579, iconFa: '' },
          { capture: 'Работа с текстом', iconClass: '', num: 431, iconFa: '' },
          { capture: 'Реклама', iconClass: '', num: 211, iconFa: '' },
          { capture: 'Работа в программах', iconClass: '', num: 2239, iconFa: '' },
          { capture: 'Психология', iconClass: '', num: 995, iconFa: '' },
          { capture: 'Видео', iconClass: '', num: 1819, iconFa: '' },
          { capture: 'Спорт', iconClass: '', num: 3132, iconFa: '' },
          { capture: 'Вопросы по профессии', iconClass: 'iconFire', num: 185, iconFa: '' },
        ],
      ...
      registrationButton: {
        ...
        capture: 'Пройдите быструю регистрацию',
      },
      userReviews: {
        sid: 'UserReviews',
